...
def extract_last_laps(df, failures_np, event_name=None):
    ...
    model_path = "../saved_models/v2_woPits/AD_19-23_autoencoder_AdamW_lr0001_loss0.0407_fold5.pth"
    sequence_length = 20
    ...
    threshold = 0.8881 * 10 # 99.9th percentile, computed on the training set
